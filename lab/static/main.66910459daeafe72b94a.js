...
/******/ 		return __webpack_require__.p + "" + ({"vendors~brython":"vendors~brython","vendors~coffee":"vendors~coffee","vendors~p5":"vendors~p5","vendors~typescript":"vendors~typescript","typescript":"typescript","vendors~vega":"vendors~vega","vega":"vega"}[chunkId]||chunkId) + "." + {"0":"cc98107762fcc28532b3","1":"055322dcf6c2bb19185f","vendors~brython":"573bac019ecde4ea1fc5","vendors~coffee":"d08447c5614c19fae334","vendors~p5":"458655f951217b0c53d8","vendors~typescript":"670aff2e298ed0c062b5","typescript":"c7d81b421646d9d31747","vendors~vega":"63238f391cc3013ee800","vega":"91b98e783d16fd1b9e23"}[chunkId] + ".js"
/******/ 	}
/******/
...
module.exports = __webpack_require__(/*! /home/travis/miniconda3/envs/jyve-dev/share/jupyter/lab/staging/build/index.out.js */"ANye");
...
function main() {
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-brython-unsafe')) {
      disabled.matches.push('@deathbeds/jyve-kyrnel-brython-unsafe');
    } else {
      module = __webpack_require__(/*! @deathbeds/jyve-kyrnel-brython-unsafe/lib/extension.js */ "YJUJ");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-coffee-unsafe')) {
      disabled.matches.push('@deathbeds/jyve-kyrnel-coffee-unsafe');
    } else {
      module = __webpack_require__(/*! @deathbeds/jyve-kyrnel-coffee-unsafe/lib/extension.js */ "0q6S");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-p5-unsafe')) {
      disabled.matches.push('@deathbeds/jyve-kyrnel-p5-unsafe');
    } else {
      module = __webpack_require__(/*! @deathbeds/jyve-kyrnel-p5-unsafe/lib/extension.js */ "ee2p");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-typescript-unsafe')) {
      disabled.matches.push('@deathbeds/jyve-kyrnel-typescript-unsafe');
    } else {
      module = __webpack_require__(/*! @deathbeds/jyve-kyrnel-typescript-unsafe/lib/extension.js */ "EWrb");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-lyb-d3')) {
      ...
      module = __webpack_require__(/*! @deathbeds/jyve-lyb-d3/ */ "3fC+");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-lyb-phosphor')) {
      ...
      module = __webpack_require__(/*! @deathbeds/jyve-lyb-phosphor/ */ "1Ybs");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve')) {
      disabled.matches.push('@deathbeds/jyve');
    } else {
      module = __webpack_require__(/*! @deathbeds/jyve/lib/extension.js */ "yiCp");
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-js-unsafe')) {
      disabled.matches.push('@deathbeds/jyve-kyrnel-js-unsafe');
    } else {
      module = __webpack_require__(/*! @deathbeds/jyve-kyrnel-js-unsafe/lib/extension.js */ "LR6y");
      extension = module.default;
...
/******/ });
//# sourceMappingURL=main.66910459daeafe72b94a.js.map