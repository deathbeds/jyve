...
function main() {
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-brython-unsafe')) {
      ...
      module = require('@deathbeds/jyve-kyrnel-brython-unsafe/lib/extension.js');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-coffee-unsafe')) {
      ...
      module = require('@deathbeds/jyve-kyrnel-coffee-unsafe/lib/extension.js');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-p5-unsafe')) {
      ...
      module = require('@deathbeds/jyve-kyrnel-p5-unsafe/lib/extension.js');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-typescript-unsafe')) {
      ...
      module = require('@deathbeds/jyve-kyrnel-typescript-unsafe/lib/extension.js');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve')) {
      ...
      module = require('@deathbeds/jyve/lib/extension.js');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-kyrnel-js-unsafe')) {
      ...
      module = require('@deathbeds/jyve-kyrnel-js-unsafe/lib/extension.js');
      extension = module.default;
